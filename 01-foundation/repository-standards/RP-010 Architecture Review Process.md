# RP-010 Architecture Review Process
...
**Status:** Active
**Owner:** EOS Team
**Audience:** Architecture Review Board, All Engineering Personnel
...
## Governance
This process is governed by the EOS Architecture Board. No review is considered valid unless it strictly conforms to this ten-point structure. AI may generate the initial draft of a review based on this template, but all decisions and mandates MUST be validated and accepted by a human engineer.
