...
The Project Standard is the definitive rulebook for a specific engineering project (e.g., "ExampleProject"). The engineering project repository is the physical execution of the Project Standard. A project MUST NOT contain architectural paradigms, tools, or workflows that contradict its governing Project Standard.
